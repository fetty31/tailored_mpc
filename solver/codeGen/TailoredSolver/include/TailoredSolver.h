...
/* Generated by FORCESPRO v6.0.0 on Wednesday, November 2, 2022 at 7:50:16 PM */
...
{
    /* vector of size 400 */
    TailoredSolver_float lb[400];

    /* vector of size 400 */
    TailoredSolver_float ub[400];

    /* vector of size 160 */
    TailoredSolver_float hu[160];

    /* vector of size 10 */
    TailoredSolver_float xinit[10];

    /* vector of size 400 */
    TailoredSolver_float x0[400];

    /* vector of size 1120 */
    TailoredSolver_float all_parameters[1120];
...
/* Time of Solver Generation: (UTC) Wednesday, November 2, 2022 7:50:22 PM */
...
/* Solver Id: 5340ddcc-62d1-4dca-a529-d1d48f6bf1e9 */
