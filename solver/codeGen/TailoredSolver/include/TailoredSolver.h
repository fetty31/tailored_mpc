...
/* Generated by FORCESPRO v6.0.0 on Monday, November 14, 2022 at 7:05:26 PM */
...
{
    /* vector of size 330 */
    TailoredSolver_float lb[330];

    /* vector of size 300 */
    TailoredSolver_float ub[300];

    /* vector of size 150 */
    TailoredSolver_float hu[150];

    /* vector of size 10 */
    TailoredSolver_float xinit[10];

    /* vector of size 330 */
    TailoredSolver_float x0[330];

    /* vector of size 930 */
    TailoredSolver_float all_parameters[930];
...
{
    /* vector of size 180 */
    TailoredSolver_float U[180];

    /* vector of size 150 */
    TailoredSolver_float X[150];
...
/* Time of Solver Generation: (UTC) Monday, November 14, 2022 7:05:30 PM */
...
/* Solver Id: 3576f7ea-f215-4478-96be-1a1eca55a700 */
