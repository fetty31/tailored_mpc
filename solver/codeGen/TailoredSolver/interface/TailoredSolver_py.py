...
#    def from_param(self):
#        return self
    _fields_ = [('lb', ctypes.c_double * 440),
('ub', ctypes.c_double * 400),
('hu', ctypes.c_double * 200),
('xinit', ctypes.c_double * 10),
('x0', ctypes.c_double * 440),
('all_parameters', ctypes.c_double * 1240),
...
#    def from_param(self):
#        return self
    _fields_ = [('U', ctypes.c_double * 240),
