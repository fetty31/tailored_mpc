...
% 
classdef TailoredSolverBuildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function [output,exitflag,info] = forcesInitOutputsMatlab()
            ...
            outputs_U = coder.nullcopy(zeros(320, 1));
            outputs_X = coder.nullcopy(zeros(200, 1));
        ...
        function [output,exitflag,info] = forcesCall(lb, ub, hu, xinit, x0, all_parameters, num_of_threads)
            ...
            [output, exitflag, info] = TailoredSolverBuildable.forcesInitOutputsMatlab();
    ...
    methods (Static, Access = private)
        function [output,exitflag,info] = forcesInitOutputsC()
            ...
            outputs_U = coder.nullcopy(double(zeros(320, 1)));
            outputs_X = coder.nullcopy(double(zeros(200, 1)));
            output = struct('U', outputs_U,...
                            'X', outputs_X);
