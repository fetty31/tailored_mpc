...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.0
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['lb'] - column vector of length 330
       PARAMS['ub'] - column vector of length 300
       PARAMS['hu'] - column vector of length 150
       PARAMS['xinit'] - column vector of length 10
       PARAMS['x0'] - column vector of length 330
       PARAMS['all_parameters'] - column vector of length 930
       PARAMS['num_of_threads'] - scalar

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['U'] - column vector of size 180
       OUTPUT['X'] - column vector of size 150
...
#    def from_param(self):
#        return self
    _fields_ = [('lb', ctypes.c_double * 330),
('ub', ctypes.c_double * 300),
('hu', ctypes.c_double * 150),
('xinit', ctypes.c_double * 10),
('x0', ctypes.c_double * 330),
('all_parameters', ctypes.c_double * 930),
...
#    def from_param(self):
#        return self
    _fields_ = [('U', ctypes.c_double * 180),
('X', ctypes.c_double * 150),
]
